...
/* Task 1) Create a form that asks for the pokedex number and uses that to place the information of the pokemon that corresponds to that number on the page
    Rules: 
...
/* Challenge) Edit your code so you can put in the name of the pokemon instead of the pokedex number to get it's info (If you manage to finish this, help out those around you)
    Rules:
        - Any additions to the HTML aside from the form and whatever goes inside of that is NOT allowed.
    Hints:
